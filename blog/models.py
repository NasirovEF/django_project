...
class Blog(models.Model):
    heading = models.CharField(max_length=150, verbose_name="Заголовок", help_text="Придумайте заголовок статьи")
    ...
    create_date = models.DateTimeField(default=timezone.now, verbose_name="Дата", **NULLABLE)
